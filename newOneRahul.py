...
def submenu1():
    print ("Press 1 for delete capital :  ")
    print ("Press 2 for delete flower : ")
...
def delete_key():
    print("delete key")
    country=input("which you want to delete country in key :")
    submenu1()
    choice = int(input("Enter the choice : "))
    match choice:
        case 1:
            capital = input("Enter the capital name : ")
            del country_data[country]['capital']
            
        case 2:
            flower = input("Enter the flower name : ")
            del country_data[country]['flower']
    print(country_data[country])
